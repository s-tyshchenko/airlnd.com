...
class ControllerCatalogProduct extends Controller {
    ...
    $data['manufacturers'] = $this->model_catalog_manufacturer->getManufacturers();
		...
		if (isset($this->request->post['product_related_2'])) {
			$products_2 = $this->request->post['product_related_2'];
		} elseif (isset($this->request->get['product_id'])) {
			$products_2 = $this->model_catalog_product->getProductRelated2($this->request->get['product_id']);
		} else {
			$products_2 = array();
		}

		$data['product_relateds_2'] = array();

		foreach ($products_2 as $product_id) {
			$related_info = $this->model_catalog_product->getProduct($product_id);
