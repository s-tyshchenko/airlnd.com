	...
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/footertitle')) {
				$menu[] = array(
					'name'	   => $this->language->get('text_header_menu_title'),
			...
			if ($this->user->hasPermission('access', 'catalog/footerlink')) {
				$menu[] = array(
					'name'	   => $this->language->get('text_header_menu_link'),
			...
			if ($menu) {
				$data['menus'][] = array(
					'id'       => 'menu-menu',
					'icon'	   => 'fa-bars', 
					'name'	   => $this->language->get('text_header_menu'),
					'href'     => '',
					'children' => $menu
				);		
			}
      ...
      // OCFilter start
		...
		/* octeam */
            ...
            if ($this->user->hasPermission('access', 'report/synchronization')) {
                $report_sync[] = array(
                    'name'	   => $this->language->get('text_report_synchronization'),
                    'href'     => $this->url->link('report/synchronization', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
