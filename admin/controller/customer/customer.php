...
class ControllerCustomerCustomer extends Controller {
	...
	protected function getList() {
		...
		$data['entry_customer_type'] = $this->language->get('entry_customer_type');
	...
	protected function getForm() {
		...
		$data['customer_types'] = [
		    [
		        'customer_type_id' => 1,
                'name' => $this->language->get('entry_customer_type_1')
            ],
            [
		        'customer_type_id' => 2,
                'name' => $this->language->get('entry_customer_type_2')
            ]
        ];
		...
		if (isset($this->request->post['customer_type_id'])) {
			$data['customer_type_id'] = $this->request->post['customer_type_id'];
		} elseif (!empty($customer_info)) {
			$data['customer_type_id'] = $customer_info['customer_type_id'];
		} else {
			$data['customer_type_id'] = $this->config->get('config_customer_type_id');
		}
