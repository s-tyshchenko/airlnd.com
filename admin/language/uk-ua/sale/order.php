...
$_['text_account_custom_field'] = 'Додаткові поля аккаунта покупця';
$_['text_payment_custom_field'] = 'Додаткові поля адреси оплати покупця';
$_['text_shipping_custom_field'] = 'Додаткові поля адреси доставки покупця';
...
// Help
$_['help_override'] 		= 'Включити ігнорування, якщо статус замовлення був автоматично змінений системою протидії шахрайству.';
// Error
$_['error_warning'] 		= 'Уважно перевірте форму на наявність помилок';
$_['error_permission'] 		= 'У вас немає прав для редагування замовлень';
$_['error_action'] 		= 'Дія не може бути завершена';
