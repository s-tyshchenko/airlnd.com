...
class ModelCatalogfootertitle extends Model {
	public function addfootertitle($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "footertitle SET  status = '" . (int)$data['status'] . "', link = '" . $this->db->escape($data['link']) . "', image = '" . $this->db->escape($data['image']) . "', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function editfootertitle($footertitle_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "footertitle SET status = '" . (int)$data['status'] . "', image = '" . $this->db->escape($data['image']) . "', link = '" . $this->db->escape($data['link']) . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE footertitle_id = '" . (int)$footertitle_id . "'");
