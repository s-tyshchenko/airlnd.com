...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		if (isset($data['product_related_2'])) {
			foreach ($data['product_related_2'] as $related_id) {
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_related_2 WHERE product_id = '" . (int)$product_id . "' AND related_id = '" . (int)$related_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_related_2 SET product_id = '" . (int)$product_id . "', related_id = '" . (int)$related_id . "'");
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_related_2 WHERE product_id = '" . (int)$related_id . "' AND related_id = '" . (int)$product_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_related_2 SET product_id = '" . (int)$related_id . "', related_id = '" . (int)$product_id . "'");
			}
		}
	...
	public function editProduct($product_id, $data) {
		...
		/* $data_name_1 = $data['product_description']['1']['name'];
		$data_name_3 = $data['product_description']['1']['name'];
		$data_model = $data['model'];
		
		for($i=0; $i < 10; $i++){
			$data['product_description']['1']['name'] = $data_name_1 . ' ' . $i;
			$data['product_description']['3']['name'] = $data_name_3 . ' ' . $i;
			$data['model'] = $data_model . $i;
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "product_related_2 WHERE product_id = '" . (int)$product_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "product_related_2 WHERE related_id = '" . (int)$product_id . "'");
	...
	public function copyProduct($product_id) {
		...
		// OCFilter end
			...
			$data['product_related_2'] = $this->getProductRelated2($product_id);
	...
	public function getProductRelated2($product_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_related_2 WHERE product_id = '" . (int)$product_id . "'");
