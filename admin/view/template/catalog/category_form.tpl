        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_image; ?> (SVG иконка для меню)</label>
                <div class="col-sm-10"><a href="" id="thumb-image-2" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_menu; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="image_menu" value="<?php echo $image_menu; ?>" id="input-image-2" />
                </div>
              </div>
              <div class="form-group">
