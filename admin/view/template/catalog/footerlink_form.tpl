          ...
          <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
			...
			<div class="form-group">
			  ...
			  <div class="form-group hidden">
                <label class="col-sm-2 control-label" for="input-style_heading">Стиль заголовка</label>
                <div class="col-sm-10">
				  <select name="style_heading" id="input-style_heading" class="form-control">
				  <?php if($style_heading){ ?>
					<option value="0">Обычный</option>
					<option value="1" selected="selected">Красный (Сортировка по цвету)</option>
				  <?php } else { ?>
					<option value="0" selected="selected">Обычный</option>
					<option value="1">Красный (Сортировка по цвету)</option>
				  <?php } ?>
                </select>
                </div>
              </div>
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="min-height: 150px;max-height: 500px;overflow: auto;">
                    ...
                    <tr>
                      <td class="checkbox">
                        <label>
                          <?php if (in_array($category['category_id'], $selected_category)) { ?>
