        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-related_2"><span data-toggle="tooltip" title="<?php echo $help_related; ?>"><?php echo $entry_related; ?> (Аналоги)</span></label>
                <div class="col-sm-10">
                  <input type="text" name="related_2" value="" placeholder="<?php echo $entry_related; ?>" id="input-related_2" class="form-control" />
                  <div id="product-related_2" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($product_relateds_2 as $product_related_2) { ?>
                    <div id="product-related_2<?php echo $product_related_2['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_related_2['name']; ?>
                      <input type="hidden" name="product_related_2[]" value="<?php echo $product_related_2['product_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
...
// Related
$('input[name=\'related_2\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
	...
	'select': function(item) {
		$('input[name=\'related_2\']').val('');

		$('#product-related_2' + item['value']).remove();

		$('#product-related_2').append('<div id="product-related_2' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="product_related_2[]" value="' + item['value'] + '" /></div>');
	}
});

$('#product-related_2').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
//--></script>
  <script type="text/javascript"><!--
