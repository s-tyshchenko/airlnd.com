                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-customer-type"><?php echo $entry_customer_type; ?></label>
                        <div class="col-sm-10">
                          <select name="customer_type_id" id="input-customer-type" class="form-control">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-email"><?php echo $entry_company; ?></label>
                        <div class="col-sm-10">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-email"><?php echo $entry_edrpou; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="edrpou" value="<?php echo $edrpou; ?>" placeholder="<?php echo $entry_edrpou; ?>" id="input-edrpou" class="form-control" />
                          <?php if ($error_edrpou) { ?>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-email"><?php echo $entry_ipn; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="ipn" value="<?php echo $ipn; ?>" placeholder="<?php echo $entry_ipn; ?>" id="input-ipn" class="form-control" />
                          <?php if ($error_ipn) { ?>
