      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
			...
			<li><a href="#tab-footer-social-icons" data-toggle="tab">Социальные сети</a></li>
          </ul>
          <div class="tab-content">
			
			<div class="tab-pane" id="tab-footer-social-icons">
			  <div class="form-group hidden">
                <label class="col-sm-2 control-label" for="facebook">Facebook URL</label>
                <div class="col-sm-10">
                  <input class="form-control" id="facebook" type="text" name="config_facebook" placeholder="Facebook" value="<?php echo $config_facebook; ?>" />
                </div>
              </div>
			  <div class="form-group hidden">
                <label class="col-sm-2 control-label" for="instagram">Instagram URL</label>
                <div class="col-sm-10">
                  <input class="form-control" id="instagram" type="text" name="config_instagram" placeholder="Instagram" value="<?php echo $config_instagram; ?>" />
                </div>
              </div>
			  ...
			  <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input class="form-control" id="telegram" type="text" name="config_telegram" placeholder="Telegram" value="<?php echo $config_telegram; ?>" />
                </div>
              </div>
			  
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="viber">Viber</label>
                <div class="col-sm-10">
                  <input class="form-control" id="viber" type="text" name="config_viber" placeholder="Viber" value="<?php echo $config_viber; ?>" />
                </div>
              </div>
			  ...
			  <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input class="form-control" id="whatsapp" type="text" name="config_whatsapp" placeholder="Whatsapp" value="<?php echo $config_whatsapp; ?>" />
                </div>
              </div>
