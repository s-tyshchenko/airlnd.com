...
class ControllerExtensionModuleOCFilter extends Controller
{
    ...
    public function index($settings = array())
    {
        ...
        if (isset($this->session->data['products_view'])) {
            $data['show_mobile'] = $this->session->data['products_view'] === 'list';
        } else {
            $data['show_mobile'] = true;
        }
        ...
        $this->document->addStyle('assets/amitek/vendor/ocfilter/nouislider.css');
        $this->document->addStyle('assets/amitek/vendor/ocfilter/ocfilter.css');

        $this->document->addScript('assets/amitek/vendor/ocfilter/nouislider.js');
        $this->document->addScript('assets/amitek/vendor/ocfilter/ocfilter.js');
