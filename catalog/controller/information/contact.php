...
class ControllerInformationContact extends Controller {
	...
	public function index() {
        ...
        $this->document->addStyle('assets/amitek/styles/contact.css');
		...
		$data['text_locations_description'] = $this->language->get('text_locations_description');
		$data['text_contacts'] = $this->language->get('text_contacts');
		$data['text_contacts_description'] = $this->language->get('text_contacts_description');
