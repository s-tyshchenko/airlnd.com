...
$_['text_testing']												= 'Платіжний шлюз в тестовому режимі. Кошти не були зняті.<br />Будь ласка скористайтесь іншим методом оплати.';
...
$_['text_type_help']											= 'Після натискання кнопки Підтвердити ви будете перенаправлені на ';
