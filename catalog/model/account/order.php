...
class ModelAccountOrder extends Model {
	...
	public function getOrderFiles($order_id, $parent_file_id = 0) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_files WHERE order_id = '" . (int)$order_id . "' AND customer_id = '" . (int)$this->customer->getId() . "' AND parent_file_id = '" . (int)$parent_file_id . "'");

		return $query->rows;
	}

	public function getOrderFile($file_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_files WHERE file_id = '" . (int)$file_id . "' LIMIT 1");
